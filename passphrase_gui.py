...
class PassPhrase:
    ...
    def __init__(
        self, word_count, case, separator="space", special_character=False
    ) -> None:
    ...
    def generate_pass(self):
        ...
        # the passphrase list.
        special_character = specials_list.specials_dictionary[
            int(secrets.choice(range(1, 23)))
        ]
        ...
        for i in range(self.word_count):
            ...
            try:
                phrase_words.append(
                    word_list.word_dictionary[int(number_key)].__getattribute__(
                        self.case
                    )()
                )
...
num_words = [
    [
        sg.Text("Number Of Words:", size=(25, 0), font=("Courier New", 10, "bold")),
        sg.InputOptionMenu(
            ("2", "3", "4", "5", "6", "7", "8"), default_value=3, key="words"
        ),
    ]
]
...
word_case = [
    [
        sg.Text("Word Case:", size=(25, 0), font=("Courier New", 10, "bold")),
        sg.InputOptionMenu(
            ("lower", "upper", "title"), default_value="lower", key="word_case"
        ),
    ]
]
...
word_separator = [
    [
        sg.Text("Word Separator:", size=(25, 0), font=("Courier New", 10, "bold")),
        sg.InputOptionMenu(("space", "dash"), default_value="space", key="separator"),
    ]
]
